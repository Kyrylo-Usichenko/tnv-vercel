    ...
    <StyledTools>
      <FullCon>
        <Manage>
          ...
          <Image src='/images/features/tools/manage@2x.png' alt='app' width={252} height={324} priority={true} />
          <ManageDec>
            <ManageDecDots>
        ...
        <Wrapper>
          <Message>
            <MessageeDec>
              <MessageeDecDots>
                <Image src={'/images/features/tools/message-dots.png'} alt='Dots' width={208} height={88} />
              </MessageeDecDots>
            </MessageeDec>
            <MessageButtons>
          ...
          <WrapperLine2>
            <Share>
              <ShareDec>
                <ShareDecDots>
                  <Image src='/images/features/tools/share-dots.png' alt='Dots' width={164} height={100} />
                </ShareDecDots>
              </ShareDec>
              <ShareBlock1>
                <Image src='/images/features/tools/share.svg' alt='share' width={48} height={48} priority={true} />
              </ShareBlock1>
            ...
            <Invoices>
              <InvoiceBlock1>
                <InvoiceBlock2>
                  <Image src='/images/features/tools/dollar.svg' alt='dollar' width={22} height={44} priority={true} />
                </InvoiceBlock2>
              </InvoiceBlock1>
              <InvoiceTitle>{t('features:introductionCreateInvoices')}</InvoiceTitle>
              <InvoicesDec>
                <InvoicesDecDots>
                  <Image src='/images/features/tools/invoice-dots.png' alt='Dots' width={129} height={153} />
                </InvoicesDecDots>
              </InvoicesDec>
            </Invoices>
          </WrapperLine2>
