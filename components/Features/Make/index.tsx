        ...
        <MakeCon>
          ...
          <First>
            <Second>
              <Stars>
                <div>
                  <Image src={'/images/features/make/dec.svg'} alt='Stars' layout='fill' objectFit='contain' />
                </div>
              </Stars>
              <LeftImgWrap>
                <LeftImg>
              ...
              <Dots>
                <div>
                  <Image src={'/images/features/make/dots.png'} alt='Dots' layout='fill' objectFit='contain' />
                </div>
              </Dots>
            </Second>
          </First>
