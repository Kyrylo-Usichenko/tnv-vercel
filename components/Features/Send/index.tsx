...
import LineL375 from '@/components/Features/Send/LineL375';
import LineR375 from '@/components/Features/Send/LineR375';
import LineL from '@/components/Features/Send/LineL';
import LineR from '@/components/Features/Send/LineR';
    ...
    <StyledSend>
      ...
      <FeaturesCon>
        <PreviewImg animate={animate}>
          ...
          <InvoiceImg src='/images/features/send/invoice@2x.png' alt='Invoice' loading='lazy' animate={animate} />
          <RemindImg src='/images/features/send/reminde@2x.png' alt='Reminde' loading='lazy' animate={animate} />
