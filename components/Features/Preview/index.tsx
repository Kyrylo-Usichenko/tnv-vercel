...
import LineL from '@/components/Features/Preview/LineL';
import LineR from '@/components/Features/Preview/LineR';
      ...
      <FeaturesCon>
        <PreviewInfo>
          ...
          <PreviewImg animate={animate}>
            ...
            <RequestImg src='/images/features/preview/request@2x.png' alt='Payment request' animate={animate} />
