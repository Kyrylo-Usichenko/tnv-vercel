...
const LineL = () => {
	return (
		<Svg width='722' height='316' viewBox='0 0 722 316' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<Rect
				id='rect-1'
				width='3'
				height='3'
...
function createCss() {
	...
	for (let i = 1; i <= 44; i++) {
		styles += `
       #rect-${i} {
				animation: lineLAnim 50ms ease ${delay}ms;
