...
import ManL from '@/components/Features/Breeze/ManL';
import WomenL from '@/components/Features/Breeze/WomenL';
import ConL from '@/components/Features/Breeze/ConL';
              ...
              <Block>
                <Add>
                  ...
                  <AddBlock animate={animate}>
                    <AddCon>
                      <AddFile>
                        <Image src='/images/features/breeze/file.svg' layout='fill' objectFit='contain' alt='file' />
                      </AddFile>
                      <AddText>Add Catalog to Order List</AddText>
                    </AddCon>
                    <AddArrow>
                      <Image src='/images/features/breeze/arrow.svg' layout='fill' objectFit='contain' alt='arrow' />
                    </AddArrow>
                  </AddBlock>
                ...
                <ManDec animate={animate}>
                  <Image src='/images/features/breeze/man-dec.svg' alt='stars' width={73} height={67} />
                </ManDec>
                <Man animate={animate}>
                  <ImgWrap>
                    <Image src='/images/features/breeze/man@2x.jpg' layout='fill' objectFit='contain' alt='man' />
                  </ImgWrap>
                </Man>
                <WomendDec animate={animate}>
                  <Image src='/images/features/breeze/women-dec.svg' alt='stars' width={91} height={76} />
                </WomendDec>
                <Women animate={animate}>
                  <ImgWrap>
                    <Image src='/images/features/breeze/women@2x.jpg' layout='fill' objectFit='contain' alt='man' />
                  </ImgWrap>
                </Women>
