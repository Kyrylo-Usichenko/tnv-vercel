        ...
        <Content>
          <Count>
            {isShown02 ? (
              ...
              <CountUp start={0} end={10} delay={0.3} duration={0.7} preserveValue onEnd={() => setIsShown02(true)} />
            ) : (
              0
            )}
            <span className='accent'>+</span>
        ...
        <Content>
          <Count>
            {isShown03 ? (
              ...
              <CountUp start={0} end={5000} delay={0} duration={1.5} preserveValue onEnd={() => setIsShown03(true)} />
            ) : (
              0
            )}
            <span className='accent'>+</span>
        ...
        <Content>
          <Count>
            ...
            {isShown04 ? (
              ...
              <CountUp start={0} end={500} delay={0.2} duration={1.2} preserveValue onEnd={() => setIsShown04(true)} />
            ) : (
              0
            )}
