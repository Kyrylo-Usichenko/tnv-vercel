...
import LogoText from '@/components/common/Logos/LogoText';
import {
  ArrowWrapper,
  ButtonWrapper,
  CurrentLanguage,
...
} from '@/components/common/Header/FeaturesHeaderStyles';
import ArrowDown from '@/components/common/Arrow/ArrowDown';
      ...
      <MainCon className='h-100'>
        <MobileContainer isMenuOpend={isMenuOpend}>
          <HeaderContainer>
                ...
                <LanguageMenu isOpen={dropDawn}>
                  <FlagWrapper>
                    <Link href={localeTab} locale='en'>
                      <img src='/icons/common/flags/gbflug.svg' alt='' width='24px' height='16px' />
                    </Link>
                  </FlagWrapper>
                  <FlagWrapper>
                    <Link href={localeTab} locale='id'>
                      <img src='/icons/common/flags/idflug.svg' alt='' width='24px' height='16px' />
                    </Link>
                  </FlagWrapper>
                  <FlagWrapper>
                    <Link href={localeTab} locale='th'>
                      <img src='/icons/common/flags/thflug.svg' alt='' width='24px' height='16px' />
                    </Link>
                  </FlagWrapper>
                  <FlagWrapper>
                    <Link href={localeTab} locale='vn'>
                      <img src='/icons/common/flags/viflug.svg' alt='' width='24px' height='16px' />
                    </Link>
                  </FlagWrapper>
                </LanguageMenu>
              </LanguageWrapper>
            ...
            <ButtonWrapper>
              <HeaderButton isHeaderScrolled={isHeaderScrolled} tab={tab} type='button' onClick={btnClick}>
                {t('header:GetStarted')}
              </HeaderButton>
            </ButtonWrapper>
