      ...
      <FeaturesCon>
        <Inner>
          <Title>
            ...
            <TitleWrap>
              <TitleSpan ref={typeRef} isVisible={isVisible} isBackwards={isBackwards} isIncreased={isIncreased}>
                {text}
              </TitleSpan>
            </TitleWrap>
          </Title>
        ...
        <RedSquare>
          <Null>
            <LeftMock isActive={tab.name === 'Chats'}>
              <ImageInner>
                <Image src={chatLeft} alt={tab.name} layout='fill' objectFit='contain' priority={true} />
              </ImageInner>
            </LeftMock>
            <RightMock isActive={tab.name === 'Chats'}>
              <ImageInner>
                <Image src={chatRight} alt={tab.name} layout='fill' objectFit='contain' priority={true} />
              </ImageInner>
            </RightMock>
            <LeftMock isActive={tab.name === 'Orders'}>
              <ImageInner>
                <Image src={orderLeft} alt={tab.name} layout='fill' objectFit='contain' priority={true} />
              </ImageInner>
            </LeftMock>
            <RightMock isActive={tab.name === 'Orders'}>
              <ImageInner>
                <Image src={orderRight} alt={tab.name} layout='fill' objectFit='contain' priority={true} />
              </ImageInner>
            </RightMock>
            ...
            <RightMock isActive={tab.name === 'Payments'}>
              <ImageInner>
                <Image src={payRight} alt={tab.name} layout='fill' objectFit='contain' priority={true} />
              </ImageInner>
            </RightMock>
            <Stars>
...
const TitleSpan = styled.span<{ isVisible: boolean; isBackwards: boolean; isIncreased: boolean }>`
  ...
  ${({ isVisible, isBackwards }) =>
    ...
    css`
      &::before {
        background: #ffffff;
        animation: ${isBackwards ? typewriterBack : typewriter} ${TYPE_WRITE_SPEED}s steps(${TYPE_WRITER_CHARACTERS}) 0s
