      ...
      <Wrapper>
        <Null>
          <FeaturesCon>
            <DotsLeftBot>
              <div>
                <Image src='/images/main/whyChoose/big-rombs.png' alt='Dots' layout='fill' objectFit='contain' />
              </div>
            </DotsLeftBot>
            <DotsRight>
              <div>
                <Image src='/images/main/whyChoose/small-rombs.png' alt='Dots' layout='fill' objectFit='contain' />
              </div>
            </DotsRight>
            <Inner>
              <RightSquare />
